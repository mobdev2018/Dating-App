...
let kRangeSliderHeight = CGFloat(3.0)


class CustomSlider: UISlider {
    override func trackRect(forBounds bounds: CGRect) -> CGRect {
        var newBounds = super.trackRect(forBounds: bounds)
        newBounds.size.height = kRangeSliderHeight
        return newBounds
    }
}
...
public class RangeSliderTrackLayer: CALayer {
    ...
    override open func draw(in ctx: CGContext) {
        ...
        let rect1 = CGRect(origin: .zero, size: CGSize(width: bounds.size.width, height: kRangeSliderHeight))
        ...
        let rect = CGRect(x: lowerValuePosition, y: 0.0, width: upperValuePosition - lowerValuePosition, height: kRangeSliderHeight)
        ctx.fill(rect)
    }
}
...
public class RangeSliderThumbLayer: CALayer {
    ...
    /*override open func draw(in ctx: CGContext) {
        ...
        contents = UIImage(named: "slider-circle")?.cgImage
        // Fill
...
open class NHRangeSlider: UIControl {
    ...
    /// max value
    open var maximumValue: Double = 230.0 {
        willSet(newValue) {
   ...
   open var stepValue: Double? = nil {
    ...
    open var trackTintColor: UIColor = UIColor(patternImage: UIImage(named: "sliderSmall")!) {
        didSet {
    ...
    open var trackHighlightTintColor: UIColor = UIColor(patternImage: UIImage(named: "sliderBig")!)  {
        didSet {
            trackLayer.setNeedsDisplay()
        }
    }
    ...
    fileprivate func initializeLayers() {
        ...
        lowerThumbLayer.contents = UIImage(named: "slider-circle")?.cgImage
        layer.addSublayer(lowerThumbLayer)
        
        upperThumbLayer.rangeSlider = self
        //pperThumbLayer.contentsScale = UIScreen.main.scale
        upperThumbLayer.contents = UIImage(named: "slider-circle")?.cgImage
    ...
    open func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth/2.0, y: 0, width: thumbWidth, height: thumbWidth)
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth/2.0, y: 0, width: thumbWidth, height: thumbWidth)
